...
// Convert message from SupportedTestInstructions IntoABBResultTI used for sending to TesterGui
	...
	immatureTestInstructionMessage = &fenixTestCaseBuilderServerGrpcApi.ImmatureTestInstructionMessage{
		BasicTestInstructionInformation: &fenixTestCaseBuilderServerGrpcApi.BasicTestInstructionInformationMessage{
			NonEditableInformation: &fenixTestCaseBuilderServerGrpcApi.BasicTestInstructionInformationMessage_NonEditableBasicInformationMessage{
				...
				TestInstructionOrignalUuid:  string(supportedTestInstructionInstance.TestInstruction.TestInstructionUUID),
...
func (s *fenixTestCaseBuilderServerGrpcServicesServerStruct) processTestInstructionsBasicTestInstructionInformation(immatureTestInstructionMessageMap map[string]*fenixTestCaseBuilderServerGrpcApi.ImmatureTestInstructionMessage) (err error) {
